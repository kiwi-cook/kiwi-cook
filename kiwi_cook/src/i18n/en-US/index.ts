export default {
  ...
  chat: {
    ...
    status: {
      recipes: {
        ...
        failed: 'Sorry, I couldn’t retrieve any recipes. Please try again later.',
      },
    },
    input: {
  ...
  search: {
    ...
    query: {
      action:
        'Filter recipes by keyword. For example: <strong>Spaghetti</strong><br><br>Click on the search result to see more details.',
      placeholder: 'For example: Spaghetti Carbonara',
    ...
    results: {
      searching: 'Great! I’m now searching for recipes based on your preferences: {preferences}',
      noResults:
  ...
  // Error handling
  error: {
    notFound: 'Oops! 🥝 We can’t find this recipe. Please select another one!',
  ...
  llm: {
    ...
    summarize: 'Summarize',
    disclaimer:
      'The summary was generated by an AI model.' +
      'It is for informational purposes only and may contain errors or inaccuracies.' +
      'No responsibility is taken for its correctness.',
  },
