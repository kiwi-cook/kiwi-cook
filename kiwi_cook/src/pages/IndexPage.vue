<template>
  <q-page class="page">
    <q-page-scroller reverse position="top" :scroll-offset="20" class="page-scroller-btn">
    ...
    <div
      ...
      :class="[
        'fade-enter-active',
        {
          'q-mt-md': messages[messageIndex - 1]?.sender !== message.sender,
        },
      ]"
    >
      <q-chat-message
        ...
        :class="{
          ...
          'last-message-same':
            messages[messageIndex - 1]?.sender === message.sender && messageIndex !== 0,
        }"
                ...
                >
                  <template #append>
                    <q-btn
                      ...
                      disabled
                      icon="camera_alt"
                      @click="chat.handleMessage('photo')"
                    />
                    <q-btn
          ...
          <template v-else-if="message.type === 'slider'">
            <div class="slider-container q-pa-md rounded-borders">
              ...
              <q-slider
                ...
                :disable="messages.slice(messageIndex + 1).some((m) => m.sender !== message.sender)"
                :label-always="
                  !messages.slice(messageIndex + 1).some((m) => m.sender !== message.sender)
                "
                :label-value="
