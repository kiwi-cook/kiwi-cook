...
async function summarize(summaryData) {
...
const translate = async (translationData) => {
  ...
  const { input, sourceLanguage, targetLanguage } = translationData.data
