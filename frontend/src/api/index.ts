 ...
 */
export function getFromAPI<T extends Recipe | Item | Discount | Market>(route: API_ROUTE, options?: { callback?: (json: T[]) => void, formatObject?: { [key: string]: string | number }, body?: T}): Promise<T[]> {
