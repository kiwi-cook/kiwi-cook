import {Item, logDebug, Recipe, StepItem} from "@/tastebuddy";
import nlp from "compromise";
import {findMostSimilarItem, normalizeUnit} from "@/tastebuddy/parser/utils.ts";
...
export class AllRecipesParser {
    public static parse(allRecipesRecipe: AllRecipesRecipe): Recipe {
        ...
        for (const ingredient of allRecipesRecipe.ingredients) {
            ...
            if (!item) {
                item = Item.newItemFromName(ingredientName)
            }
