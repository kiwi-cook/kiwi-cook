<template>
    <div class="element-list-wrapper horizontal">
        <ul v-if="filteredElements.length > 0" :tabindex="0"
            class="element-list horizontal">
...
const filteredElements: Ref<unknown[]> = ref([]);
